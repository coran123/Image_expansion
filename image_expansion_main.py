...
#
# def recursive_paint2(image,factor):
#     for i in range(factor):
#         if i==0:
...
# cv2.imwrite('test_images/recursive1.jpg',images[0])
for i, image in enumerate(images):
    ...
    cv2.waitKey()
    cv2.destroyAllWindows()
    # cv2.imwrite('test_images/recursive6.jpg', image)
...
for num in range(len(picture)):
    ...
    # final=recursive_paint2(predicted_image,2)
